 ...
 * Slug: myBase/footer-default-dark
 * Categories: footer
...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color has-small-font-size" style="margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small)"><!-- wp:group {"align":"wide","layout":{"type":"flex","allowOrientation":false,"justifyContent":"space-between"}} -->
  <div class="wp-block-group alignwide"><!-- wp:paragraph -->
    <p>&copy; <?php echo esc_html(gmdate('Y')); ?> <?php echo esc_html__('Your Company LLC', 'myBase'); ?> · <a href="#"><?php echo esc_html__('Contact Us', 'myBase'); ?></a></p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p><a href="#"><?php echo esc_html__('Facebook', 'myBase'); ?></a> · <a href="#"><?php echo esc_html__('Twitter', 'myBase'); ?></a> · <a href="#"><?php echo esc_html__('Instagram', 'myBase'); ?></a></p>
    <!-- /wp:paragraph -->
  </div>
  <!-- /wp:group -->
</div>
